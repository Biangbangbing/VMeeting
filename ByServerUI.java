...
public class ByServerUI implements VMeetingConfig{
    public JFrame initUI(String title, Socket socket, String name, int ID,ByServerReceiveMsg byServerReceiveMsg){
...
//        showDia.setLocation(0,150);
        ...
        byServerReceiveMsg.setDialogTrack(showDia);
...
//        dialog.add(dialogBottom);
        ...
        ByServerListener byServerListener = new ByServerListener(jFrame,socket,inputArea,showDia,dialogTitle,name,ID);
